<section class="bg-white dark:bg-gray-900 py-8 lg:py-16 antialiased">
    <div class="max-w-4xl mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
          <h2 class="text-lg lg:text-2xl font-bold text-black dark:text-white">Комментарии</h2>
      </div>
      <form class="mb-6">
          ...
          <button type="submit"
              class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-orange rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
      ...
      <article class="p-6 text-base bg-white rounded-lg">
          <footer class="flex justify-between items-center mb-2">
              ...
              <button id="dropdownComment1Button" data-dropdown-toggle="dropdownComment1"
                  ...
                  <span class="sr-only">Настройки комментариев</span>
              </button>
              <!-- Dropdown menu -->
