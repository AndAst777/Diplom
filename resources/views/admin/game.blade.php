            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="p-4 md:p-5" action="{{ route('game.store') }}" method="POST">
                        ...
                        <button type="submit"
                            class="text-white inline-flex items-center bg-orange-600  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th scope="row"
                                ...
                                <img src="{{ asset('images/ti.png') }}" alt="">
                            </th>
                            <td class="px-6 py-4">
                                {{ $game->title }}
                            </td>
                                ...
                                <div id="put-modal" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <!-- Modal body -->
                                            <form class="p-4 md:p-5" action="{{ route('game.update', $game->id) }}"
                                                method="POST">
                                                @csrf
                                                {{-- @method('PUT') --}}
                                                <div class="grid gap-4 mb-4 grid-cols-2">
